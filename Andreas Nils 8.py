...
#in diesem Absatz werden die Werte in einer Textdatei gespeichert 
f = open("Marklerauftrag.txt", "a")
print("Name:", name, file=f)
print("Wohnungsname:", objekt, file=f)
print("Datum:", datum, file=f)
anzahl = len(Listeräume) # in den nächsten 3 Zeilen wird die Liste in Txt geschrieben
for i in range(anzahl):
    print(Listeräume[i], file=f)
print("Gesamtfläche:", gesamt2, file=f)
print("Durchschnittfläche:", durchschnitt, file=f)
f.close()
